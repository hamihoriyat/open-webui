...
WEBUI_NAME = os.environ.get("WEBUI_NAME", "Azad AI")
if WEBUI_NAME != "Azad AI":
    WEBUI_NAME += " (Azad AI)"
...
DATABASE_URL = os.environ.get("DATABASE_URL", f"postgresql://myuser:mypassword@localhost:5432/mydatabase")
