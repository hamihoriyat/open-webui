...
Revision ID: 1016cf740c38
Revises: 
Create Date: 2024-08-03 00:18:40.929546
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.String(), nullable=False),
    sa.Column('name', sa.String(), nullable=True),
    sa.Column('input_limit', sa.Integer(), nullable=True),
    sa.Column('output_limit', sa.Integer(), nullable=True),
    sa.Column('models_limit', sa.String(), nullable=True),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('name')
    )
