"""added mobile to user

Revision ID: 13f13eb08d97
Revises: 7e5b5dc7342b
Create Date: 2024-07-14 11:03:51.520958
...
def upgrade() -> None:
    ...
    op.alter_column('chatidtag', 'tag_name',
               existing_type=sa.VARCHAR(length=255),
               nullable=True)
    op.alter_column('chatidtag', 'chat_id',
               existing_type=sa.VARCHAR(length=255),
               nullable=True)
    op.alter_column('chatidtag', 'user_id',
               existing_type=sa.VARCHAR(length=255),
               nullable=True)
    op.alter_column('chatidtag', 'timestamp',
               existing_type=sa.INTEGER(),
               type_=sa.BigInteger(),
               nullable=True)
    ...
    op.alter_column('document', 'user_id',
               existing_type=sa.VARCHAR(length=255),
               nullable=True)
    op.alter_column('document', 'timestamp',
               existing_type=sa.INTEGER(),
               type_=sa.BigInteger(),
               nullable=True)
